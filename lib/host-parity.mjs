 ...
 * agree. An earlier version listed a handful of hand-picked samples and passed
 * green while the two hosts disagreed on most real inputs — a check that cannot
