...
// `/tool-intel` doc surface for brew/cask (2 ecosystem references, 2 note
...
/**
 * The six doc surfaces the v0.31.5 regression touched — the exhaustive set
 * this guard checks, repo-root-relative. Any file added later that repeats
 * brew/cask analytics-source guidance should be added here too (prose-only
 * maintenance, like the rest of this repo's drift-guard file lists).
 *
 * @type {readonly string[]}
 */
export const ANALYTICS_GUIDANCE_FILES = /** @type {const} */ ([
  'skills/tool-intel/references/ecosystem-brew.md',
  'skills/tool-intel/references/ecosystem-cask.md',
  'skills/tool-intel/references/note-template-brew.md',
  'skills/tool-intel/references/note-template-cask.md',
