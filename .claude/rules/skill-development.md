...
**Exception:** `nudge-sync` and `feature-nudge` are intentionally Claude-Code-specific (hardcoded note permalink + slug vocabulary) — a deliberate, stated break from this rule, documented in each skill's own `SKILL.md`.
